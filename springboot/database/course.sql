...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', '81a5f5a9bfde4cdcb5b9fe1f8508df2a', 255);
INSERT INTO `admin` VALUES (2, 'azure99', '81a5f5a9bfde4cdcb5b9fe1f8508df2a', 96);
...
-- Records of class
-- ----------------------------
INSERT INTO `class` VALUES (1, 1, 2017, '计1班');
INSERT INTO `class` VALUES (2, 1, 2019, '计联培1班');
...
CREATE TABLE `course`  (
  ...
  CONSTRAINT `fk_course_teacher_id` FOREIGN KEY (`course_teacher_id`) REFERENCES `teacher` (`teacher_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of course
-- ----------------------------
INSERT INTO `course` VALUES (1, 1, 'C语言程序设计', 2017, '1-1-2', '信工楼107', 5, 18, 50, NULL, NULL);
INSERT INTO `course` VALUES (2, 1, 'Java程序设计', 2019, '1-3-2', '信工楼106', 4, 0, 30, NULL, NULL);
INSERT INTO `course` VALUES (3, 1, '数据库实用技术', 2017, '2-3-2', 'C区202', 2, 1, 50, NULL, NULL);
INSERT INTO `course` VALUES (4, 1, 'ASP.Net开发', 2017, '5-5-3', 'E区315', 2, 0, 1, NULL, NULL);
INSERT INTO `course` VALUES (5, 1, 'Spring企业级开发', 2017, '3-9-2', '信工楼101', 3, 0, 10, NULL, NULL);
INSERT INTO `course` VALUES (6, 3, '数据库概论', 2017, '3-1-2', 'C区106', 5, 0, 40, NULL, NULL);
INSERT INTO `course` VALUES (7, 3, 'Photoshop', 2017, '2-3-2', 'C区222', 2, 0, 20, NULL, NULL);
INSERT INTO `course` VALUES (8, 4, '计算机网络', 2017, '4-1-3', '信工楼109', 5, 0, 20, NULL, NULL);
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (1, 1, '201711010001', '李夏莲', '81a5f5a9bfde4cdcb5b9fe1f8508df2a', '961523404@qq.com', '1998-08-19 16:09:47', 1, '2019-12-16 17:16:47');
INSERT INTO `student` VALUES (2, 1, '201711010002', '李雨轩', '81a5f5a9bfde4cdcb5b9fe1f8508df2a', NULL, NULL, 1, NULL);
...
CREATE TABLE `student_course`  (
  ...
  CONSTRAINT `fk_sc_course_id` FOREIGN KEY (`sc_course_id`) REFERENCES `course` (`course_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- ----------------------------
INSERT INTO `student_course` VALUES (1, 1, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (2, 2, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (3, 3, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (4, 4, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (5, 5, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (6, 6, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (7, 7, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (8, 8, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (9, 9, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (10, 10, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (11, 11, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (12, 12, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (13, 13, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (14, 14, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (15, 15, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (16, 16, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (17, 17, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (18, 18, 1, NULL, NULL, NULL);
INSERT INTO `student_course` VALUES (19, 1, 3, 98, 100, 99);
